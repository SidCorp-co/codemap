...
import { CODE_TABLE, TAGS, EDGE_KINDS } from '../scripts/lib/parse.mjs';
import { PROFILES } from '../scripts/lib/languages.mjs';
import { HELP_TOPICS, VERBS, renderHelp } from '../scripts/lib/help.mjs';
...
export function helpCases(pluginRoot, check) {
  const cm = join(pluginRoot, 'scripts', 'cm.mjs');
  const roots = [];
  try {
