...
import { blockingDiags } from '../scripts/lib/blocking.mjs';
import { reconcile, eventCounts, buildPayload, metricsPaths, registryFlips } from '../scripts/lib/metrics.mjs';
...
function runHook(pluginRoot, root, file) {
  const res = spawnSync(process.execPath, [join(pluginRoot, 'scripts', 'hook-post-edit.mjs')], {
