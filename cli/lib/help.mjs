...
export const VERBS = [
  ...
  ['new flow', '<name>', 'declare a flow before annotating its steps  [--description "..."] [--in <file>]'],
  ['new external', '<name>', 'declare an out-of-tree system a cm:edge may target  [--description "..."] [--in <file>]'],
...
spec/schema/codemap.schema.json. No registry ⇒ prose enforcement is OFF: the plugin can be
installed once machine-wide and no un-onboarded tree is ever blocked. Onboarding is a per-repo
decision.
